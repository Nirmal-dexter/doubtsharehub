  ...
  return (
    <div className="neon-page flex min-h-screen items-center justify-center px-4">
      <div className="glass-panel w-full max-w-md rounded-3xl p-8 text-center">
        <h1 className="text-7xl font-bold text-glow text-foreground">404</h1>
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="neon-button inline-flex items-center justify-center rounded-full px-5 py-2.5 text-sm font-semibold"
          >
            Go home
          </Link>
        </div>
